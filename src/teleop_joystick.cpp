...
TeleopJoystick::TeleopJoystick(ros::NodeHandle *nh) {
    ...
    nh->param("max_rotate_degree", max_rotate_degree_, 0.25f);
...
void TeleopJoystick::joy_to_control_messages_callback(const sensor_msgs::Joy::ConstPtr &joy) {
    ...
    if (!is_translate_mode_) {
        ...
        pose_message.orientation.yaw = -joy1_x * max_rotate_degree_;
        pose_message.orientation.pitch = -joy1_y * max_rotate_degree_;
